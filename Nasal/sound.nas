...
setlistener("f16/avionics/rf/ant-sel-iff-switch", click2, nil, 0);
setlistener("f16/avionics/rf/ant-sel-uhf-switch", click2, nil, 0);
...
setlistener("f16/fcs/bit", button2, nil, 0);
...
setlistener("controls/armament/alt-rel-button", button2, nil, 0);
