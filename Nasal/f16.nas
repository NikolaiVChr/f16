...
setlistener("controls/MFD[0]/button-pressed", knob2, nil, 0);
setlistener("controls/MFD[1]/button-pressed", knob2, nil, 0);
setlistener("controls/MFD[2]/button-pressed", knob2, nil, 0);
