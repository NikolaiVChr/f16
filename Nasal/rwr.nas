...
#        printf("list %d type %s", size(list), type);
        ...
        foreach(me.contact; me.sortedlist) {
            ...
            if (!(me.typ == me.ASSET_GARGOYLE or me.typ == me.ASSET_AAA or me.typ == me.ASSET_BUK or  me.typ == me.ASSET_PAC2 or me.typ == me.ASSET_FRIGATE) and me.contact[0].get_Speed()>60) {
                #air-borne
