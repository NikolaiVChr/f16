...
var malIndLtsBtn = props.globals.getNode("controls/test/test-panel/mal-ind-lts-btn");

 var toggleMalIndLtsBtn = func {
        if(!malIndLtsBtn.getBoolValue()) {
                malIndLtsBtn.setBoolValue(1);
        } else {
                malIndLtsBtn.setBoolValue(0);
        }
 }
