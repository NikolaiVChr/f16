...
var AImodel = {
    ...
    update: func(n = nil) {
        ...
        foreach(var n ; props.globals.getNode("ai/models", 1).getChildren())
        {
            ...
            if((var valid = n.getNode("valid")) == nil or !valid.getValue() or ((n.getNode("missile") == nil or n.getNode("missile").getValue() != 1) and (n.getNode("type") == nil or n.getNode("type").getValue() != "Mig-28")))
            {
                continue;
            }
